...
public class Vec3d {
    ...
    public Vec3d normalize() {
        double d0 = (double) MathHelper.sqrt_double(
    ...
    public Vec3d crossProduct(Vec3d vec) {
        return new Vec3d(this.yCoord * vec.zCoord - this.zCoord * vec.yCoord,
            this.zCoord * vec.xCoord - this.xCoord * vec.zCoord, this.xCoord * vec.yCoord - this.yCoord * vec.xCoord);
    }
    ...
    public Vec3d getIntermediateWithXValue(Vec3d vec, double x) {
        ...
        if (d0 * d0 < 1.0000000116860974E-7D) {
            ...
            return d3 >= 0.0D && d3 <= 1.0D ? new Vec3d(this.xCoord + d0 * d3, this.yCoord + d1 * d3,
                this.zCoord + d2 * d3) : null;
        }
    }
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            ...
            return Double.compare(vec3d.xCoord, this.xCoord) != 0 ? false
                : (Double.compare(vec3d.yCoord, this.yCoord) != 0 ? false
